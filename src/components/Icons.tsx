...
export function BookmarkIcon({ size = 14, className, filled }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function UserIcon({ size = 13, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function SignOutIcon({ size = 13, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function TagIcon({ size = 15, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
